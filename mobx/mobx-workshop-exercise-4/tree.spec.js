...
test.skip('Users have an identifier and name', () => {
...
test.skip('Messages refer to an author and have a message', () => {
    expect(
        Message.is({
            author: 'a123',
            message: 'test'
...
test.skip('Store has users, messages and a selected user', () => {
    expect(
        Store.is({
            users: {
                a123: {
...
test.skip('Store can be created from an empty snapshot', () => {
    expect(Store.is({})).toBe(true);
});

test.skip('References and identifiers work', () => {
...
test.skip('There is an action to add messages', () => {
    const store = Store.create({
        users: {
            a123: {
                id: 'a123',
...
test.skip('Users have a derived view returning the amount of messages', () => {
    const store = Store.create({
        users: {
            a123: {
                id: 'a123',
