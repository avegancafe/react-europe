    ...
    return function (target, prop, descriptor) {
        if (descriptor) {
            ...
            return {
                enumerable: false,
                configurable: false,
                writable: "development" !== "production",
...
function flow(generator) {
    if (arguments.length !== 1) fail("development" && "Flow expects one 1 argument and cannot be used as decorator");
...
},{"process":8}],4:[function(require,module,exports) {
'use strict';
...
},{"mobx":6}],13:[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/mobx-workshop-exercise-1.0ca5bb35.map